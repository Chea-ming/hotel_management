...
.btn--action{
  ...
  box-shadow: 0 10px #f9ca24;
                    ...
                    <div class="card-header">
                        <h2 style="font-family: 'Glyphicons Halflings';"><b>Check IN Information</b></h2>
                    </div>
                    <div class="card-body">
                        <a href="{{ url('/checks/create') }}" style="padding:10px; background-color: #63a91f;
