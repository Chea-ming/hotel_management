...
<div class="card" >
  ...
  <div class="card-body">
      ...
      <form  style="justify-content: center; align-items: center;" action="{{ url('services') }}" method="post">
        {!! csrf_field() !!}
        ...
        <input type="text" name="RoomNumber" id="RoomNumber" class="form-control" style="width:300px;" placeholder=""><br>
          ...
          <input type="text" name="ServiceType" id="ServiceType" class="form-control" style="width:300px;" placeholder=""><br>

          <label><b>Request Time</b></label><br>
          <input type="datetime-local" name="RequestDateTime" id="RequestDateTime" class="form-control" style="width:300px;" placeholder=""><br>
